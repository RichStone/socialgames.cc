class Account::MatchesController < Account::ApplicationController
  account_load_and_authorize_resource :match, through: :gaming_session, through_association: :matches

  # GET /account/gaming_sessions/:gaming_session_id/matches
  # GET /account/gaming_sessions/:gaming_session_id/matches.json
  def index
  ...
  # GET /account/gaming_sessions/:gaming_session_id/matches/new
  def new
  end
  ...
  # POST /account/gaming_sessions/:gaming_session_id/matches
  # POST /account/gaming_sessions/:gaming_session_id/matches.json
  def create
  ...
  def destroy
    @match.destroy
    respond_to do |format|
      format.html { redirect_to [:account, @gaming_session, :matches], notice: I18n.t("matches.notifications.destroyed") }
